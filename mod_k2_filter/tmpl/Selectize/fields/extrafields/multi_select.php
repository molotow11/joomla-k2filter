...
?>
	...
	<div class="k2filter-field-multi-select k2filter-field-<?php echo $k; ?>">
		...
		<select name="array<?php echo $field->id; ?>[]" multiple="multiple"<?php if($onchange) : ?> onchange="submit_form_<?php echo $module->id; ?>()"<?php endif; ?> placeholder="<?php echo JText::_('MOD_K2_FILTER_FIELD_SELECT_DEFAULT').' '.JText::_($field->name); ?>">
		<?php
		if($field->content) {
