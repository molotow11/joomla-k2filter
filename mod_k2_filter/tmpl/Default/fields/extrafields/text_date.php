...
<script type="text/javascript">
	...
	<div class="k2filter-field-text-date">
		...
		<input autocomplete="off" class="datepicker inputbox" name="searchword<?php echo $field->id;?>" type="text" <?php if (JRequest::getVar('searchword'.$field->id)) echo ' value="'.JRequest::getVar('searchword'.$field->id).'"'; ?> />
	</div>
