...
<script type="text/javascript">
	...
	<div class="k2filter-field-created">	
		...
		<input autocomplete="off" placeholder="<?php echo JText::_('MOD_K2_FILTER_FIELD_RANGE_FROM'); ?>" class="datepicker inputbox" name="created-from" type="text" <?php if (JRequest::getVar('created-from')) echo ' value="'.JRequest::getVar('created-from').'"'; ?> /> - 
		<input autocomplete="off" placeholder="<?php echo JText::_('MOD_K2_FILTER_FIELD_RANGE_TO'); ?>" class="datepicker inputbox" name="created-to" type="text" <?php if (JRequest::getVar('created-to')) echo ' value="'.JRequest::getVar('created-to').'"'; ?> />
	</div>
